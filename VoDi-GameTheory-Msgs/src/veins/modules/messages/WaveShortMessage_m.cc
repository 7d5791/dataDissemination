...
void WaveShortMessage::copy(const WaveShortMessage& other)
{
    ...
    this->MulKjUjPowN_var = other.MulKjUjPowN_var;
    this->KjUj_var = other.KjUj_var;
...
void WaveShortMessage::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->MulKjUjPowN_var);
    doPacking(b,this->KjUj_var);
...
void WaveShortMessage::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->MulKjUjPowN_var);
    doUnpacking(b,this->KjUj_var);
...
Coord& WaveShortMessage::getSourcePos()
{
    return sourcePos_var;
}

void WaveShortMessage::setSourcePos(const Coord& sourcePos)
{
    this->sourcePos_var = sourcePos;
}
...
double WaveShortMessage::getMulKjUjPowN() const
{
    return MulKjUjPowN_var;
}

void WaveShortMessage::setMulKjUjPowN(double MulKjUjPowN)
{
    this->MulKjUjPowN_var = MulKjUjPowN;
}

double WaveShortMessage::getKjUj() const
{
    return KjUj_var;
}

void WaveShortMessage::setKjUj(double KjUj)
{
    this->KjUj_var = KjUj;
}
...
int WaveShortMessageDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "sourcePos")==0) return base+13;
    ...
    if (fieldName[0]=='v' && strcmp(fieldName, "vecX")==0) return base+17;
    if (fieldName[0]=='v' && strcmp(fieldName, "vecY")==0) return base+18;
    if (fieldName[0]=='v' && strcmp(fieldName, "vecZ")==0) return base+19;
    if (fieldName[0]=='M' && strcmp(fieldName, "MulKjUjPowN")==0) return base+20;
    if (fieldName[0]=='K' && strcmp(fieldName, "KjUj")==0) return base+21;
    if (fieldName[0]=='c' && strcmp(fieldName, "carId")==0) return base+22;
    if (fieldName[0]=='t' && strcmp(fieldName, "timeIdleChannel")==0) return base+23;
    if (fieldName[0]=='h' && strcmp(fieldName, "hopCount")==0) return base+24;
...
std::string WaveShortMessageDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 13: {std::stringstream out; out << pp->getSourcePos(); return out.str();}
        ...
        case 17: return double2string(pp->getVecX());
        case 18: return double2string(pp->getVecY());
        case 19: return double2string(pp->getVecZ());
        case 20: return double2string(pp->getMulKjUjPowN());
        case 21: return double2string(pp->getKjUj());
        case 22: return long2string(pp->getCarId());
        case 23: return double2string(pp->getTimeIdleChannel());
        case 24: return long2string(pp->getHopCount());
        default: return "";
    }
}
...
bool WaveShortMessageDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 17: pp->setVecX(string2double(value)); return true;
        case 18: pp->setVecY(string2double(value)); return true;
        case 19: pp->setVecZ(string2double(value)); return true;
        case 20: pp->setMulKjUjPowN(string2double(value)); return true;
        case 21: pp->setKjUj(string2double(value)); return true;
        case 22: pp->setCarId(string2long(value)); return true;
        case 23: pp->setTimeIdleChannel(string2double(value)); return true;
        case 24: pp->setHopCount(string2long(value)); return true;
...
void *WaveShortMessageDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 13: return (void *)(&pp->getSourcePos()); break;
        default: return NULL;
    }
}
