...
#ifndef metricsBySecond_H
#define metricsBySecond_H
 ...
 */
class metricsBySecond : public BaseWaveApplLayer {
	public:
	...
	protected:
        ...
        // function to reduce matrix to r.e.f.  Returns a value to
         ...
         void LogToFile(metrics m1, WaveShortMessage* wsm);
