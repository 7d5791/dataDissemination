...
#include "veins/modules/messages/beaconFat_m.h"
...
class BaseWaveApplLayer : public BaseApplLayer {
	...
	protected:
		...
		virtual void depureVector();



		virtual double intervalBeacon(double channelQuality, double priorityMsg );
	...
	protected:
		...
		//new fields for beacon messages
		 ...
		 double maxSpeedUrban;
		 double intervalBeaconWatch;

		 std::vector<int> indicesWarnigMsgs;
